...
func (s *BasePromptDSLParserListener) EnterSysSection(ctx *SysSectionContext) {}

// ExitSysSection is called when production sysSection is exited.
func (s *BasePromptDSLParserListener) ExitSysSection(ctx *SysSectionContext) {}
...
func (s *BasePromptDSLParserListener) EnterTextBlock(ctx *TextBlockContext) {}

// ExitTextBlock is called when production textBlock is exited.
func (s *BasePromptDSLParserListener) ExitTextBlock(ctx *TextBlockContext) {}
